...
Mistura* iniciarMisturas(CenarioItem* cenarioItemIncial) {
	...
	//misturas[0].itens[1] = *buscarCenarioItem(cenarioItemIncial, 1);
	//misturas[0].itens[2] = *buscarCenarioItem(cenarioItemIncial, 1);

	//misturas[1].novoItem = buscarCenarioItem(cenarioItemIncial, 1);
	//misturas[1].itens[0] = *buscarCenarioItem(cenarioItemIncial, 1);
	//misturas[1].itens[1] = *buscarCenarioItem(cenarioItemIncial, 1);
	//misturas[1].itens[2] = *buscarCenarioItem(cenarioItemIncial, 1);
